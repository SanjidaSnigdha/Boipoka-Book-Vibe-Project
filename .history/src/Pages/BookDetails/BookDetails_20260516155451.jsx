    ...
    return (
        <div className='w-11/12 mx-auto flex justify-between mt-15 mb-15 gap-15'>
         ...
         <div>
          ...
          <p className='border-t-1 border-0 border-b-1 mt-2'>{category}</p>
         <button className='btn btn-accent m-2 mt-2'>Read</button>
            <button className='btn btn-info m-2 mt-2'>WishList</button>
           </div>
        </div>
    );
};
