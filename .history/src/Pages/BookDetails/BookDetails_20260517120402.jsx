...
const BookDetails = () => {
    ...
    return (
     ...
     <p className='mt-4 mb-4'>{category}</p>
          ...
          <div className='mt-4'>
            <p className='text-[#131313]70'>Number of Pages: <span>{totalPages}</span></p>
            <p className='text-[#131313]70'>Publisher: <span>{publisher}</span></p>
            <p className='text-[#131313]70'>Year of Publishing: <span>{yearOfPublishing}</span></p>
            <p className='text-[#131313]70'>Rating: <span>{rating}</span></p>
          </div>
